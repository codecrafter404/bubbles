...
type OrderItemQuery struct {
	...
	loadTotal  []func(context.Context, []*OrderItem) error
...
func (_q *OrderItemQuery) QueryItem() *ItemQuery {
...
func (_q *OrderItemQuery) WithItem(opts ...func(*ItemQuery)) *OrderItemQuery {
	query := (&ItemClient{config: _q.config}).Query()
...
func (_q *OrderItemQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OrderItem, error) {
	...
	if _q.withItem != nil || _q.withOrder != nil {
		withFKs = true
	}
	if withFKs {
...
func (_q *OrderItemQuery) loadItem(ctx context.Context, query *ItemQuery, nodes []*OrderItem, init func(*OrderItem), assign func(*OrderItem, *Item)) error {
